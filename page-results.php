<?php get_header('single'); ?>
        <main class="results-main">
            <h1 class="page-heading"><?php echo get_theme_mod('page_results', 'Results'); ?><span id="page-results"></span></h1>
            <div class="season-results-container">
                <div class="upcoming-match">
                    <h2 class="upcoming-header"><?php echo get_theme_mod('page_last_match', 'Last match'); ?><span id="page-last-match"></span></h2>
